  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        - <span class="pub-badge pub-badge--fse">FSE-TD</span>**EquivFusion: Unifying Hardware Equivalence Checking from Algorithms to Netlists via MLIR** [📄](files/papers/EquivFusion_FSE2026.pdf)  
          Jiaying Zhu, Baoqi Zhang, Kezhi Li, Hao Yan, Qiang Xu, **Min Li**  
          ACM International Conference on the Foundations of Software Engineering - Tool Demonstrations Track, 2026.
